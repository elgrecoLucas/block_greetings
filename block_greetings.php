...
class block_greetings extends block_base {
    ...
    public function get_content() {
        ...
        if (!empty($this->config->text)) {
            ...
            // MUESTRO EL FORMULARIO PARA POSTEAR UN MENSAJE !!
            if ($allowpost) {
                $text .= $messageform->render();
            }

            // Lógica para publicar el mensaje en la BD !!
            if ($data = $messageform->get_data()) {
                // ESTABA USANDO UN PERMISO DE LOCAL/GREETINGS!!!!!!!!!!!!!!!!!!!! RARO!!!!!!!!!!!!
                // ACÁ SE JUSTIFICA LA DEPENDENCIA!!!! DEPENDENCIA CON EL local/greetings
            ...
            // ACÁ SE ARMAN LAS TARJETAS CON LOS MENSAJES/POSTEOS !!!!
            // ESTA USANDO UN PERMISO DE LOCAL/GREETINGS!!!!!!!!!!!!!!!!!!!!!!!!!!!!! RARO
    ...
    public function applicable_formats() {
        //En este CASO SE PUEDE APLICAR SOLO AL DASHBOARD!!!!!!!!!
        return ['my' => true];
    }
}
